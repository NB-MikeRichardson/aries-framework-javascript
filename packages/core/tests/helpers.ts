...
export async function setupCredentialTestsDEMO(
  faberName: string,
  aliceName: string,
  autoAcceptCredentials?: AutoAcceptCredential
) {
  ...
  const {
    schema,
    definition: { id: credDefId },
  } = await prepareForIssuance(faberAgent, ['name', 'age', 'degree', 'college', 'profile_picture', 'x-ray'])
...
export async function setupJsonLdProofsTestMultipleCredentials(
  ...
  const inputVaccineDocAsJson: JsonCredential = {
    ...
    issuanceDate: '2019-12-03T12:19:52Z',
    expirationDate: '2029-12-03T12:19:52Z',
    name: 'Vaccination Information v1',
    credentialSubject: {
      id: holderDidKey.did,
  ...
  const inputVaccineDocAsJsonV2: JsonCredential = {
    ...
    issuanceDate: '2019-12-03T12:19:52Z',
    expirationDate: '2029-12-03T12:19:52Z',
    name: 'Vaccination Information v2',
    credentialSubject: {
      id: holderDidKey.did,
      type: 'VaccinationEvent',
      batchNumber: '1183738569',
  ...
  console.log("Credential 1 = ", signCredentialOptions)
  ...
  console.log("Credential 2 = ", signCredentialOptionsV2)
  ...
  console.log("Credential 3 = ", signCredentialOptionsVaccination)
  ...
  console.log("Credential 4 = ", signCredentialOptionsVaccinationV2)
...
export async function setupCombinedSeparateIndyAndJsonLdProofsTest(
  faberName: string,
  aliceName: string,
  autoAcceptProofs?: AutoAcceptProof
) {
  ...
  combinedFormatIssuerCredentialRecord = await faberAgent.credentials.offerCredential({
    comment: 'some comment about credential',
    connectionId: faberConnection.id,
    credentialFormats: {
      jsonld: signCredentialOptions,
