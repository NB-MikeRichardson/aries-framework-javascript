...
import { CredentialRepository, V1CredentialService } from '../../modules/credentials'
...
describe('Agent', () => {
  ...
  describe('Dependency Injection', () => {
    it('should be able to resolve registered instances', () => {
      ...
      expect(container.resolve(V1CredentialService)).toBeInstanceOf(V1CredentialService)
    ...
    it('should return the same instance for consequent resolves', () => {
      ...
      expect(container.resolve(V1CredentialService)).toBe(container.resolve(V1CredentialService))
