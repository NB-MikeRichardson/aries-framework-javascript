...
export class V1CredentialService {
   ...
   * To create a proposal as response to an existing credential exchange, use {@link V1CredentialService#createProposalAsResponse}.
   *
  ...
  public async createProposal(
    ...
    console.log(">>>>>>>>>>>>>>>> threadId = ", proposalMessage.threadId)
    // Create record
   ...
   * To create a proposal not bound to an existing credential exchange, use {@link V1CredentialService#createProposal}.
   *
   ...
   * the information from the credential proposal message. Use {@link V1CredentialService#createOfferAsResponse}
   ...
   * To create an offer not bound to an existing credential exchange, use {@link V1CredentialService#createOffer}.
   *
   ...
   * the information from the credential offer message. Use {@link V1CredentialService#createRequest}
   ...
   * the information from the credential request message. Use {@link V1CredentialService#createCredential}
   ...
   * the information from the issue credential message. Use {@link V1CredentialService#createAck}
